...
public class RejectedCampaignsFragments extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Query query = store.collection("Campaigns").whereEqualTo("campaignApprove","2").whereEqualTo("userId", userID);
